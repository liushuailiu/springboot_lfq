...
<head>
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath}/js/china.js"></script>
    <script type="text/javascript">
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, first) {
                        ...
                        $.each(first.children, function (index1, second) {
                            c += "<p style='text-align: center'><a href='#' class=\"easyui-linkbutton\" onclick=\"addTabs('" + second.href + "','" + second.title + "','" + second.iconCls + "')\">" + second.title + "</p></a>";
                        })
                        $("#aa").accordion('add', {
                            title: first.title,
                            content: c,
        ...
        function addTabs(href, title, iconCls) {
...
<div data-options="region:'north',split:true" style="height:60px;background-color:  #5C160C">
    ...
    <div style="font-size: 16px;color: #FAF7F7;font-family: 楷体;width: 300px;float:right;padding-top:15px">欢迎您:${sessionScope.user.name }
